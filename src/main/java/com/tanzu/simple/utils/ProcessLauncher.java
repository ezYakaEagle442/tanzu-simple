package com.tanzu.simple.utils;
...
public class ProcessLauncher {
	...
	private int execute() throws IOException {
		...
		// Consommation des fluxs de sortie standard et d'erreur dans des threads
		// separes.
		if (err == null) {
	...
	/**
	 * Renvoie l'OutputStream vers lequel a ete redirige le flux de sortie standard
	 * de l'application externe
	 * 
	 * @return l'OutputStream vers lequel a ete redirige le flux de sortie standard
	 *         de l'application externe
	 */
